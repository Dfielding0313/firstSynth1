...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_2BF2F567478B41A7A7ACF706E77F0643
#define AU_COCOA_VIEW_NAME AUCocoaView_2BF2F567478B41A7A7ACF706E77F0643
...
const char* kAAXBundleID = "rackafxuser.aax.firstSynth.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.firstSynth.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.firstSynth.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "firstSynth";     // 31 chars max for AAX
const char* kShortPluginName = "firstSynth";    // 15 chars max for AAX
const char* kAUBundleName = "firstSynth";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'jklm'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{2BF2F567-478B-41A7-A7AC-F706E77F0643}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'nopq';
