...
bool PluginCore::initPluginParameters()
{
	...
	// --- discrete control: LFO 1 Waveform
	piParam = new PluginParameter(controlID::lfo1Waveform, "LFO 1 Waveform", "Triangle,Sin,Saw,RSH,QRSH,Noise,QRNoise", "Triangle");
	...
	// --- continuous control: LFO 1 fo
	piParam = new PluginParameter(controlID::lfo1Frequency_Hz, "LFO 1 fo", "Hz", controlVariableType::kDouble, 0.020000, 20.000000, 0.500000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&lfo1Frequency_Hz, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: LFO 1 Dly
	piParam = new PluginParameter(controlID::lfo1DelayTime_mSec, "LFO 1 Dly", "mSec", controlVariableType::kDouble, 0.000000, 2000.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&lfo1DelayTime_mSec, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: LFO 1 Ramp
	piParam = new PluginParameter(controlID::lfo1RampTime_mSec, "LFO 1 Ramp", "mSec", controlVariableType::kDouble, 0.000000, 2000.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
